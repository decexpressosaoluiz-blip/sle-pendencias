...
const ConnectionStatus: React.FC = () => {
    ...
    return (
        <div className="flex items-center gap-2 px-3 py-1.5 rounded bg-slate-800/50 mt-2 border border-slate-700/50" title={isOnline ? "Conectado à API Google Sheets" : "Sem conexão com a API"}>
